...
class LocalRepository extends Repository
{
    ...
    public function optimize()
    {
        ...
        $modules->each(function ($module) {
            ...
            if (!$module->has('enabled')) {
                $module->put('enabled', config("kathus.locations.$this->location.enabled", true));
            }
    ...
    {
        if (!$this->files->isDirectory(storage_path("app/kathus"))) {
            $this->files->makeDirectory(storage_path("app/kathus"));
        }

        $location = Str::slug($this->location);

        return storage_path("app/kathus/$location.json");
    }
}
