...
abstract class Repository implements RepositoryContract
{
    ...
    {
        return $this->path ?: $this->config->get("kathus.locations.$this->location.path");
    }
    ...
    {
        $filename = config("kathus.locations.$this->location.manifest") ?: 'module.json';
    ...
    {
        return rtrim($this->config->get("kathus.locations.$this->location.namespace"), '/\\');
    }
}
