...
class KathusMigrateResetCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'kathus:module:migrate:reset';
    ...
    /**
     * sing the arguments, generate a list of slugs to reset the migrations for.
     *
     * @param Repository $repository
