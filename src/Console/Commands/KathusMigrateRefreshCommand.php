...
class KathusMigrateRefreshCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'kathus:module:migrate:refresh';
    ...
    protected function resetMigrations(Repository $repository)
    {
        ...
        $this->call('kathus:module:migrate:reset', [
            'slug' => $slug,
